...
long temp = 0, i = 0, reloj = 0; //Núcleo 1 y reloj.
long temp_2 = 0, i2 = 0; //Núcleo 2.
long temp_3 = 0, i3 = 0;
long temp_4 = 0, i4 = 0;
...
void simulador_computador::ejecutar_n1(){
    ...
    if (LCP == 1){
        ui->bus_secuandario_1->setText(ui->registro_cp->text());
    }
    else{
    ...
    if (LE == 1){
        ui->bus_secuandario_1->setText(ui->puerto_entrada->text().toUpper());
    }

    //Carga el contenido del bus principal al registro de contador de programa.
    if (CCP == 1){
        ui->registro_cp->setText(ui->bus_secuandario_1->text());
    }
    else {
    ...
    if (CRDM == 1){
        ui->registro_dm->setText(ui->bus_secuandario_1->text());
    }
    else {
    ...
    if (CS == 1){
        ui->puerto_salida->setText(ui->bus_secuandario_1->text());
    }
    else {
...
void simulador_computador::ejecutar_n2(){
    ...
    //Carga el contenido del Registro de Contador de Programa hacia el bus
    if (LCP == 1){
        ui->bus_secundario_2->setText(ui->registro_cp->text());
    }
    else{
    ...
    //Carga el contenido del puerto de entrada al bus principal.
    if (LE == 1){
        ui->bus_secundario_2->setText(ui->puerto_entrada->text().toUpper());
    }

    //Carga el contenido del bus principal al registro de contador de programa.
    if (CCP == 1){
        ui->registro_cp->setText(ui->bus_secundario_2->text());
    }
    else {
    ...
    //Cargar el contenido del bus en el puerto de salida.
    if (CS == 1){
        ui->puerto_salida->setText(ui->bus_secundario_2->text());
    }
    else {
    ...
    /** Revisar si se debe incluir el reloj **/
...
void simulador_computador::ejecutar_n3(){
    ...
    ui->reg_temp_3->setText(QString::number(temp, 16).toUpper());
    ...
    //Carga el contenido del registro F hacia el bus principal.
    if (LF == 1){
        ui->bus_principal->setText(ui->reg_f_3->text());
    }
    else{
    ...
    //Carga el contenido del bus hacia el registro de instrucciones.
    if (CRI == 1){
        ui->reg_inst_3->setText(ui->bus_principal->text());
        uc_3.cargar_ri(ui->reg_inst_3->text().toLong(&ok, 16));
    }
    else {
    ...
    //Cargar contenido del bus principal hacia el registro A.
    if (CA == 1){
        ui->reg_a_3->setText(ui->bus_principal->text());
    ...
    //Cargar contenido del bus principal hacia el registro B.
    if (CB == 1){
        ui->reg_b_3->setText(ui->bus_principal->text());
    ...
    if (RT == 1){
        ...
        temp = ui->reg_temp_3->text().toLong();
        ++temp;
    }
...
void simulador_computador::ejecutar_n4(){
    ...
    ui->reg_temp_4->setText(QString::number(temp, 16).toUpper());
    ...
    //Carga el contenido del registro F hacia el bus principal.
    if (LF == 1){
        ui->bus_principal->setText(ui->reg_f_4->text());
    }
    else{
    ...
    //Carga el contenido del bus hacia el registro de instrucciones.
    if (CRI == 1){
        ui->reg_inst_4->setText(ui->bus_principal->text());
        uc_4.cargar_ri(ui->reg_inst_4->text().toLong(&ok, 16));
    }
    else {
    ...
    //Cargar contenido del bus principal hacia el registro A.
    if (CA == 1){
        ui->reg_a_4->setText(ui->bus_principal->text());
    ...
    //Cargar contenido del bus principal hacia el registro B.
    if (CB == 1){
        ui->reg_b_4->setText(ui->bus_principal->text());
    ...
    if (RT == 1){
        ...
        temp = ui->reg_temp_4->text().toLong();
        ++temp;
    }
